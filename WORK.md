...
- 2026-09-08: Owner requested timing of the current video, THEN bounded parallel image/video tests. Per-account dispatch caps deployed in PR #15 / production `c306838`. 25 Python + 20 Node targeted tests pass. Live tests confirmed two images + one video accepted together; Creaa explicitly rejected image #3 and video #2. Runtime Creaa-only probe caps changed by Codex at 2026-09-07T20:01:53+00:00 on owner request: account 64287 images/videos/total 1/1/1 → 3/2/5, temporarily allowing one request above each advertised provider cap. At 2026-09-07T20:04:41+00:00 Codex set verified operating caps 3/2/5 → 2/1/3 after the probes. Flow throttle unchanged. Rejected probe jobs I3/V2 were explicitly resolved as failed with no provider task created; parallel images I1/I2 both succeeded (~125 s / ~121 s, finishing ~1.3 s apart). Additional video V1 `cj_3b0d3be8fec84af5975f` remains tracked automatically by the backend; no new jobs are queued. The initial video succeeded at 19:57:09 UTC: 102.342 s local queue + 697.179 s provider time = 799.521 s total; ffprobe confirms 1280x720 H.264/AAC, 4.064 s. Backend-only caps rollout may now proceed before bounded live probes. Record each test setting and restore/result in this board.
...
- Production runs `c306838` (PR #15), verified deployment `qagfmenha2rixqi0gpaahdki` finished healthy, globally published extension package remains **3.3.10**; owner tests local **3.4.0**. `feat/async-submit-status` remains unmerged; leave it alone.
