...
- Initial accounts/models were 0. After owner enabled the worker: account 64287, 14 models. Live GPT Image 2 test completed (`cj_fc6b6582328f4c5b8761`), PNG verified HTTP 200/image/png, 1,521,068 bytes. Seedance 2.5 test succeeded (`cj_84fabed77fe34b6a95cc`): 102.342 s local queue, 697.179 s after upstream acceptance, 799.521 s total. MP4 download returns 200; ffprobe verifies 1280x720 H.264/AAC and 4.064 s duration. Both requests use unlimited_only; actual ledger deductions have not been independently audited.
